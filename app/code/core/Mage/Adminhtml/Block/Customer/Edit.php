...
class Mage_Adminhtml_Block_Customer_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    //added by raybiztech for dealer functionality.	
	...
	$head = $this->getLayout()->getBlock('head');
        $head->addJs('megnor/jquery-1.7.1.min.js');
	$head->addJs('advancedpopup/jquery/jquery.noconflict.js');
	$head->addJs('admincustom.js');
